...
require_once(APPPATH. "sdk/OAuthSINA.php");
/* 
 * Code based on: 
...
{ 
    ...
    function get_short_url_mbs( $url_short, $page, $watermark ){
      $param = array(
        'url_short' => $url_short,
        'count' => 200,
        'page' => $page,
      ...
      $ret = $this->oauth->get('http://api.t.sina.com.cn/short_url/share/statuses.json', $param);
      return $ret;
    }


    function get_short_url_comments( $url_short, $page, $watermark ){
      $param = array(
        'url_short' => $url_short,
        'count' => 200,
        'page' => $page,
      ...
      $ret = $this->oauth->get('http://api.t.sina.com.cn/short_url/comment/comments.json', $param);
      return $ret;
    }
