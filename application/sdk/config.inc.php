...
$config->CALLBACK = 'http://www.demo.com/renren-api-php-sdk/example/oauth/2_callback.php'; //回调地址，注意和您申请的应用一致

$config->APIURL		= 'http://api.renren.com/restserver.do'; //RenRen网的API调用地址，不需要修改
$config->APIKey		= '32149c3fcce84f4dbb16d27a3a9e4d63';	//你的API Key，请自行申请
$config->SecretKey	= '6e671bd6b85d42b4bc23b1a31c6c2fd1';	//你的API 密钥
