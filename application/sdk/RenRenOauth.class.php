...
class RenRenOauth extends RESTClient {
	...
	public function getAuthorizeUrl() {
		$url = $this->_config->AUTHORIZEURL . '?response_type=code&client_id=' . $this->_config->APIKey . '&scope=publish_feed' . '&redirect_uri=' . urlencode($this->_config->CALLBACK) . '&x_renew=true';
		return $url;
	}
