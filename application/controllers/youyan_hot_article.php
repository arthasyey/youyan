<?php
class YouYan_Hot_Article extends CI_Controller {
  ...
  function index(){
	...
	$data['main_content'] = 'youyan_list_article_view';
	$this->load->view('youyan_list_article_view',$data);
  }

  function getListArticle(){
	$this->load->model('comment_model');
	echo json_encode($this->comment_model->getListArticle());
  }
  //verifyDomain
 /**
