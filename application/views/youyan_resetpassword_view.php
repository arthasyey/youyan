...
<body>
	...
	<div class="backPassContainer">
		<div class="backPassTitle">重置 <?php echo $email;?> 的密码 </div>
		<div class="backPassIntro">新密码(6位以上)</div>
		<input type="password" id="passWordA" class="enterEmail"/>
		<div class="backPassIntro">再次输入密码</div>
		<input type="password" id="passWordB" class="enterEmail"/>
		<div class="backActionPane">
			<a class="submitReset" onclick="resetPassDone('<?php echo $email;?>')">确定</a>
