...
function getPars(){
  var src = document.getElementById("UYScriptArticleHotness").src;
  var pos = src.indexOf('?');
...
document.getElementById("uyan_list_article_hotness_frame").innerHTML="<div style='width:100px;padding:5px;' id='UYloadingArticleHotness'><div style='background:url(http://uyan.cc/images/loadingA.png);width:72px;height:16px;'></div><img sytle='width:80px;height:12px;padding-top:3px;display:block;' src='http://uyan.cc/images/loading.gif'/></div>";
...
function iframeContinue(){
  ...
  // Setting id, title, content, and img
	...
	var UYSrc = "http://uyan.cc/index.php/youyan_hot_article?rankType="+encodeURIComponent(UYRankType)+"&title=" + encodeURIComponent(UYPageTitle) + "&url=" + encodeURIComponent(UYPageURL) + "&master_id=" + qstring['UYUserId'] + "&domain=" + encodeURIComponent(UYPageDomain) + "&pageId=" + encodeURIComponent(UYId) + "&pageImg=" + encodeURIComponent(UYImg) + "&pageContent=" + UYPageContent;
	var UYHotArticleSocket = new easyXDM.Socket({
		remote: UYSrc,
		swf: "http://uyan.cc/easyXDM/easyxdm.swf",
		container: "uyan_list_article_hotness_frame",
		props: {id: "UYArticleHotWrapperFrame",
                        scrolling : "no"},
		onMessage: function(message, origin){
			var currentHeight = parseInt(message);
			currentHeight +=10;
			document.getElementById("UYArticleHotWrapperFrame").style.height = currentHeight + "px";
			document.getElementById("UYArticleHotWrapperFrame").style.width = "100%";
			//this.container.getElementsById("UYHotWrapperFrame").style.height = message + "px";
			document.getElementById("UYloadingArticleHotness").style.display="none";	
		},
		onReady: function() {
			UYHotArticleSocket.postMessage("2");
		}
	}); 
}
