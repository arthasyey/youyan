...
function getPars(){
  var src = document.getElementById("UYScriptArticleTime").src;
  var pos = src.indexOf('?');
...
function iframeContinue(){
  ...
  // Setting id, title, content, and img
	...
	var UYTimeArticleSocket = new easyXDM.Socket({
		...
		container: "uyan_list_article_time_frame",
		props: {id: "UYArticleTimeWrapperFrame",
                        scrolling : "no"},
		onMessage: function(message, origin){
			var currentHeight = parseInt(message);
			currentHeight +=10;
			document.getElementById("UYArticleTimeWrapperFrame").style.height = currentHeight + "px";
			document.getElementById("UYArticleTimeWrapperFrame").style.width = "100%";
			//this.container.getElementsById("UYHotWrapperFrame").style.height = message + "px";
			document.getElementById("UYloadingArticleTime").style.display="none";	
		},
		onReady: function() {
			UYTimeArticleSocket.postMessage("2");
		}
	}); 
}
